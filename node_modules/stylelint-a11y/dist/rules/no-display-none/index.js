...
var ruleName = exports.ruleName = 'a11y/no-display-none';

var messages = exports.messages = _stylelint.utils.ruleMessages(ruleName, {
  expected: function expected(selector) {
    return 'Unexpected using "{ display: none; }" in ' + selector;
  }
});
...
function check(selector, node) {
  ...
  return !node.nodes.some(function (o) {
    return o.type === 'decl' && o.prop.toLowerCase() === 'display' && o.value.toLowerCase() === 'none';
  });
}